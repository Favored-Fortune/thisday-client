...
(module => {
  ...
  requestView.getAll = () =>
    $.get('https://history.muffinlabs.com/date/12/20')
      .then(console.log)
  //     .catch(errorCallback);
  // const resultView = {};
  ...
  // });
  // $.get(`https://history.muffinlabs.com/10/25`, (request, response)){

  //   console.log(data);
  // }
  // });
  // requestView.getAll = () => {
  //   $.get(`https://history.muffinlabs.com/${month}/${day}`)
  //   console.log('history');
  // }
...
//     }
//   }
//   module.historyData = historyData;
// })(app)
